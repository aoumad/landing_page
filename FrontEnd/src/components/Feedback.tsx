...
function Feedback() {
  return (
    <div className='flex flex-col w-full h-[500px] py-16 px-4 bg-white'>
        ...
        <div className='max-w-[1280px] flex flex-row flex-nowrap justify-between md:gap-4 mx-auto md:px-24 md:py-8'>
            ...
            <div className='flex flex-col flex-wrap justify-center items-center py-4 mx-auto'>
              <GiRecycle size={50} />
              <p className='text-[#3b3a3a] font-bold text-xl sm:text-2xl md:text-3xl flex items-center justify-center'>Clubs And Groups</p>
                <span className='text-sm font-light text-[#6e6a6a]'>Our membership management
                <br/> software provides full automation of
                <br /> membership renewals and payments
                </span>
