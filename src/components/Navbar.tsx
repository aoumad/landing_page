  ...
  return (
    <div className='flex justify-between items-center h-24 w-full mx-auto px-4 text-black bg-slate-50'>
        ...
        <ul className='hidden md:flex'>
            ...
            <button className='bg-[#205a48] w-[50px] rounded-md mx-24 px-24 py-4 whitespace-nowrap flex justify-center items-center text-white font-semibold'>Login in {'->'}</button>
        </ul>
